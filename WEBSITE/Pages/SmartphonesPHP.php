...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Smartphones
                </h1>
                <ol class="breadcrumb">
                    <li><a href="Homepage.html">Home</a>
                    </li>
                    <li><a href="AllDevCategories.html">All Device Categories</a>
                    </li>
        ...
        <!-- /.row -->
            ...
            <div class="col-md-12">
                <img class="img-responsive" src="../Images/prodotti.png" alt="">
            </div>
    ...
    <div class="row">
                ...
                <div class="col-sm-3 col-xs-6">
                   <center> <a href="DISPOSITIVO.php?dev=LGG5">
                        <img class="img-responsive img-hover img-related" src="../Images/LGG5.png" alt="">
                    </a>
                    <p>LG G5</p>
                    </center>
                </div>
               ...
               <div class="col-sm-3 col-xs-6">
                   <center> <a href="#">
                        <img class="img-responsive img-hover img-related" src="../Images/HuaweiP9.png" alt="">
                    </a>
                    <p>Huawei P9</p>
                    </center>
                </div>
                 ...
                 <div class="col-sm-3 col-xs-6">
                   <center> <a href="#">
                        <img class="img-responsive img-hover img-related" src="../Images/AppleIPhone6s.png" alt="">
                    </a>
                    <p>Apple Iphone 6s</p>
                    </center>
                </div>
                 ...
                 <div class="col-sm-3 col-xs-6">
                   <center> <a href="#">
                        <img class="img-responsive img-hover img-related" src="../Images/MicrosoftLumia.png" alt="">
                    </a>
                    <p>Microsoft Lumia</p>
                    </center>
                </div>
