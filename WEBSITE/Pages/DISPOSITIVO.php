                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="fill" src="../Images/LG_G51.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="fill" src="../Images/LG_G52.jpg" alt="">
                        </div>
                        <div class="item" >
                            <img class="fill" src="../Images/LG_G53.jpg" alt="">
                        </div>
